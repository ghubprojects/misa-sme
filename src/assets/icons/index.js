...
export { default as IconVietnamFlag } from './IconVietnamFlag.vue';
export { default as IconEnglandFlag } from './IconEnglandFlag.vue';
...
// icon dialog
export { default as IconDialogWarning } from './IconDialogWarning.vue';
export { default as IconDialogError } from './IconDialogError.vue';

// icon table header buttons
