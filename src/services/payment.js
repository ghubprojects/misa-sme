...
const detailsEndpoint = 'Payments/Details';
...
export const getAllDetailsAsync = async (
    id = '',
    keyword = '',
    limit = table.INIT_RECORD_PER_PAGE,
    offset = table.INIT_OFFSET_VALUE
) => {
    return await httpRequest.get(detailsEndpoint, {
        params: { id, keyword, limit, offset }
    });
};
 ...
 * Created by: ttanh (26/08/2023)
 */
export const removeMultipleAsync = async (data) => {
    return await httpRequest.remove(endpoint, data);
};
